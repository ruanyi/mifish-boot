package com.ruanyi.mifish.mqproxy.message.handler;
...
import static com.ruanyi.mifish.mqproxy.model.QueueMessage.MSG_INVOKE_TS;
import static com.ruanyi.mifish.mqproxy.model.QueueMessage.MSG_RESOLVE_TS;
...
import com.ruanyi.mifish.mqproxy.message.resolver.CommonConsumerExceptionResolver;
import com.ruanyi.mifish.mqproxy.message.resolver.JsonConsumerMethodArgsResolver;
...
public class SimpleMessageHandler implements MessageHandler {
    ...
    private MqproxyConsumerMetaContainer consumerMetaContainer = MqproxyConsumerMetaContainer.getInstance();
