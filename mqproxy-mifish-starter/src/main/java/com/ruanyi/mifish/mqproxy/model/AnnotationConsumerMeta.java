...
public class AnnotationConsumerMeta implements Serializable {
     ...
     * @return
     */
    public MqproxyConsumer getMqproxyConsumer() {
    ...
    public String getPoolName() {
        if (this.annotation instanceof MqproxyConsumer) {
            MqproxyConsumer mqproxyConsumer = getMqproxyConsumer();
            return mqproxyConsumer.poolName();
        }
        return null;
    }
