...
public final class ImageInfo extends MetaInfo {
     ...
     * @param desc
     */
    private ImageInfo(Integer status, String desc) {
        super(status, desc);
    }
    ...
    public static ImageInfo failure(String errInfo) {
        ...
        Integer status = Integer.parseInt(metas.get("status") + "");
        String desc = metas.get("desc") + "";
        return new ImageInfo(status, desc);
    }
