 ...
 */
public class KaproxyStartupMeta {
     ...
     * @return
     */
    public static KaproxyStartupMeta of(String effectGroupTopics) {
     ...
     * @return
     */
    public static KaproxyStartupMeta of(String effectGroupTopics, int consumeConcurrency, int consumptionRate,
                                        int handleConcurrency) {
        KaproxyStartupMeta kaproxyStartupMeta = new KaproxyStartupMeta();
        kaproxyStartupMeta.effectGroupTopics = effectGroupTopics;
        kaproxyStartupMeta.consumeConcurrency = consumeConcurrency;
        kaproxyStartupMeta.consumptionRate = consumptionRate;
        kaproxyStartupMeta.handleConcurrency = handleConcurrency;
