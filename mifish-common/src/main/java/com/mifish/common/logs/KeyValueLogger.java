...
import com.mifish.common.context.RequestContext;
import com.mifish.common.utils.JackJsonUtil;
...
import static com.mifish.common.context.RequestContext.getCurrentRequestId;
import static com.mifish.common.utils.ThreadUtils.getThreadName;
import static com.mifish.common.utils.ThrowableUtil.getStackTrace;
...
public interface KeyValueLogger {
    ...
    default void trace(Pair<?, ?>... pairs) {
        if (isTraceEnabled()) {
            ...
            params.put("requestId", getCurrentRequestId());
    ...
    default void debug(Throwable t, Pair<?, ?>... pairs) {
        if (isDebugEnabled()) {
            ...
            params.put("stackTrace", getStackTrace(t));
            getLogger().debug("{}", JackJsonUtil.toJSONString(params));
        }
    }
